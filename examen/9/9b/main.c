/*
Se citesc dintr-un fisier transmis ca si parametru in linie de comanda, numerele
naturale n si k (n<=26, k<=n) si apoi un alfabet format din n litere distincte.
